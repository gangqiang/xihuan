...
//hh("清空",1,600).ttip=Calendar._TT["CLEAR"];
...
this._nav_now=hh(Calendar._TT["TODAY"],this.weekNumbers?3:2,0);
this._nav_now.ttip=Calendar._TT["GO_TODAY"];
this._nav_cl=hh("清空",1,600).ttip=Calendar._TT["CLEAR"];
this._nav_nm=hh("&#x203a;",1,1);
...
break;
case 37:case 38:case 39:case 40:if(act)
{
...
function BindCalendar(inputField, buttonField, options)
{
	var defaultOp =
	{
		dateStatusFunc: null,
